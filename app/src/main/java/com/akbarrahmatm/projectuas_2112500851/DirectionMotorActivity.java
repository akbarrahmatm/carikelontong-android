...
public class DirectionMotorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_direction_motor);
        ...
        progressDialog.setMessage("Mohon Tunggu, Sedang Memuat Arah Yang Menggunakan Motor");
        progressDialog.show();
    ...
    public void setRouteMaps(Double destLat, Double destLong, String namatoko) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ActivityCompat.checkSelfPermission(DirectionMotorActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                if (isGPSEnabled()) {

                    LocationServices.getFusedLocationProviderClient(DirectionMotorActivity.this)
                            .requestLocationUpdates(locationRequest, new LocationCallback() {
                                ...
                                public void onLocationResult(@NonNull LocationResult locationResult) {
                                    ...
                                    if (locationResult != null && locationResult.getLocations().size() > 0) {
                                        ...
                                        RoadManager roadManager = new OSRMRoadManager(DirectionMotorActivity.this, "MyOwnUserAgent/1.0");
                                        ...
                                        Double durationVal = (road.mDuration / 60) / 6;
        ...
        result.addOnCompleteListener(new OnCompleteListener<LocationSettingsResponse>() {
            ...
            public void onComplete(@NonNull Task<LocationSettingsResponse> task) {
                ...
                try {
                    ...
                    Toast.makeText(DirectionMotorActivity.this, "GPS is already tured on", Toast.LENGTH_SHORT).show();
                    ...
                    switch (e.getStatusCode()) {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            try {
                                ...
                                resolvableApiException.startResolutionForResult(DirectionMotorActivity.this, 2);
